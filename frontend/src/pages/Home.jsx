                    ...
                    <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
                        ...
                        <div>
                            <div className="lg:w-[570px]">
                                <h1 className='text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]'>We patients live a healthy, longer life.</h1>
                                <p className='text__para'>Doctor’s appointment booking system is an app for all
                                 types of doctors who wants to go digital. The app can help non-emergency patients to schedule an appointment through the app only. It saves a lot of time for the receptionist as all the things are done from the app. People can book the slot where the doctor is available as well as the patients can show up. Some of the use cases also include regular checkups, dentist appointments, non-emergency checkups, etc.
                                 The app is perfect for any doctor who is planning to go digital.
                                </p>
                            ...
                            {/* =========== hero counter =========== */}
                            <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lag:gap-[30px]'>
                                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
                        ...
                        <div className='py-[30px] px-5'>
                            ...
                            <div className='mt-[30px]'>
                                ...
                                <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid-[#181A1E] mt-[30px] mx-auto  flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
                    ...
                    <div className="flex items-center justify-between flex-col lg:flex-row">
                        ...
                        <div className='xl:w-[670px]'>
                            ...
                            <ul className='pl-4'>
                                ...
                                <li className='text__para'>3. View physicians who are accepting new patients, use the online scheduling tool to select appointment time.</li>
